                                            ...
                                            <table class="table table-striped">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="checkbox" id="restaurants-list" value="restaurants" name="restaurants[]" class="permission">
                                                            <label class=" control-label2" for="restaurants-list">{{ trans('lang.list') }}</label>
                                                            <input type="checkbox" id="restaurants-create" value="restaurants.create" name="restaurants[]" class="permission">
                                                            <label class=" control-label2" for="restaurants-create">{{ trans('lang.create') }}</label>
                                                            <input type="checkbox" id="restaurants-edit" value="restaurants.edit" name="restaurants[]" class="permission">
                                                            <label class=" control-label2" for="restaurants-edit">{{ trans('lang.edit') }}</label>
                                                            <input type="checkbox" id="restaurants-view" value="restaurants.view" name="restaurants[]" class="permission">
                                                            <label class=" control-label2" for="restaurants-view">{{ trans('lang.view') }}</label>
                                                            <input type="checkbox" id="restaurant-delete" value="restaurant.delete" name="restaurant[]" class="permission">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <input type="checkbox" id="driver-delete" value="driver.delete" name="drivers[]" class="permission">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <input type="checkbox" id="foods-delete" value="foods.delete" name="foods[]" class="permission">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="checkbox" id="restaurant-payouts-list" value="restaurantsPayouts" name="restaurant-payouts[]" class="permission">
                                                            <label class=" control-label2" for="restaurant-payouts-list">{{ trans('lang.list') }}</label>
                                                            <input type="checkbox" id="restaurant-payouts-create" value="restaurantsPayouts.create" name="restaurant-payouts[]" class="permission">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <input type="checkbox" id="payout-request-restaurant" value="payoutRequests.restaurants" name="payout-request[]" class="permission">
