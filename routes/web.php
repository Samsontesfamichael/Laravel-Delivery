...
Route::middleware(['permission:god-eye,map'])->group(function () {
    ...
    Route::get('/map/get_active_drivers', [App\Http\Controllers\MapController::class, 'getActiveDrivers'])->name('map.getActiveDrivers');
    Route::get('/map/get_driver_location/{driverId}', [App\Http\Controllers\MapController::class, 'getDriverLocation'])->name('map.getDriverLocation');
});

Route::middleware(['permission:drivers,driver.assignment'])->group(function () {
    Route::post('/delivery/assign/drivers', [App\Http\Controllers\DeliveryAssignmentController::class, 'getNearestDrivers'])->name('delivery.assign.drivers');
    Route::post('/delivery/auto_assign', [App\Http\Controllers\DeliveryAssignmentController::class, 'autoAssignOrder'])->name('delivery.autoAssign');
    Route::get('/delivery/assignment/history/{driverId}', [App\Http\Controllers\DeliveryAssignmentController::class, 'getAssignmentHistory'])->name('delivery.assignment.history');
    Route::get('/delivery/assignment/analytics', [App\Http\Controllers\DeliveryAssignmentController::class, 'getAssignmentAnalytics'])->name('delivery.assignment.analytics');
});

Route::middleware(['permission:drivers,proof_of_delivery'])->group(function () {
    Route::post('/delivery/proof/upload', [App\Http\Controllers\ProofOfDeliveryController::class, 'uploadProof'])->name('delivery.proof.upload');
    Route::post('/delivery/proof/verify', [App\Http\Controllers\ProofOfDeliveryController::class, 'verifyProof'])->name('delivery.proof.verify');
    Route::get('/delivery/proof/{orderId}', [App\Http\Controllers\ProofOfDeliveryController::class, 'getProof'])->name('delivery.proof.get');
    Route::get('/delivery/proof/download/{orderId}', [App\Http\Controllers\ProofOfDeliveryController::class, 'downloadProof'])->name('delivery.proof.download');
});

Route::middleware(['permission:drivers,driver.reviews'])->group(function () {
    Route::get('/driver/reviews', [App\Http\Controllers\DriverReviewsController::class, 'getDriverReviews'])->name('driver.reviews.get');
    Route::get('/driver/review/{reviewId}', [App\Http\Controllers\DriverReviewsController::class, 'getReviewDetail'])->name('driver.review.get');
    Route::delete('/driver/review/{reviewId}', [App\Http\Controllers\DriverReviewsController::class, 'deleteReview'])->name('driver.review.delete');
    Route::get('/driver/rating/stats/{driverId}', [App\Http\Controllers\DriverReviewsController::class, 'getRatingStats'])->name('driver.rating.stats');
    Route::get('/driver/rating/monthly/{driverId}', [App\Http\Controllers\DriverReviewsController::class, 'getMonthlyStats'])->name('driver.rating.monthly');
    Route::post('/driver/review/reply', [App\Http\Controllers\DriverReviewsController::class, 'replyToReview'])->name('driver.review.reply');
});
